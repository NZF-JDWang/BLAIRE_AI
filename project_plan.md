...
- [x] Implement multimodal parsing pipeline for text/PDF/image ingestion via LlamaIndex components.
- [x] Implement Obsidian vault indexer with initial full index + delta updates.
